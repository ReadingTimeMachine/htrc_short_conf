...
# See Paper 1 for more info: https://arxiv.org/abs/2209.04460
...
binaries_file = ''# for final test set
no_splits = True # if set to true, only 1 set of tfrecords files is created, all labeled as "test"
test_list_dir = save_binary_dir #'/Users/jnaiman/Dropbox/wwt_image_extraction/FigureLocalization/StoredFeatures/MegaYolo_htrc/'
